...
const (
	...
	// ASKPASS_SOCKET_PATH_ENV is the environment variable that is used to pass the socket path to the askpass script
	ASKPASS_SOCKET_PATH_ENV = "ARGOCD_ASK_PASS_SOCK"
...
func init() {
	SocketPath = env.StringFromEnv(ASKPASS_SOCKET_PATH_ENV, SocketPath)
}
