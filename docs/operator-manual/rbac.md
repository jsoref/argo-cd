...
$ argocd-util rbac can role:staging-db-admins get applications --policy-file policy.csv
No
...
$ argocd-util rbac can role:staging-db-admins get applications --policy-file policy.csv --default-role role:readonly
Yes
```
